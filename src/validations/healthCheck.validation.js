...
const createHealthCheckValidation = Joi.object({
    ...
    location: Joi.string()
        ...
        .messages({
            ...
            "string.empty": "Location không được bỏ trống.",
            "string.min": "Location phải có ít nhất {#limit} ký tự.",
            "string.max": "Location không được vượt quá {#limit} ký tự.",
            "any.required": "Không được bỏ trống Location."
        }),
