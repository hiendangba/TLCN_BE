...
const { CreateBuildingRequest, GetBuildingRequest, UpdateBuildingRequest, DeleteBuildingRequest } = require("../dto/request/building.request")
...
const buildingController = {
    ...
    updateBuilding: asyncHandler(async (req, res) => {
        const updateBuildingRequest = new UpdateBuildingRequest(req.body)
        const response = await buildingServices.updateBuilding(updateBuildingRequest)
