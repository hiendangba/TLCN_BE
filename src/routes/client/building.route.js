...
const { createBuildingSchema, updateBuildingSchema } = require("../../validations/building.validation")
...
buildingRouter.patch("/", authMiddleware, isAdmin, validateRequest(updateBuildingSchema), buildingController.updateBuilding);
